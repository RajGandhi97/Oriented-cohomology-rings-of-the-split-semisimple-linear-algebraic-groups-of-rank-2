# -*- coding: utf-8 -*-
"""
Created on Thu Apr 15 21:33:16 2021
...
for E1 in powerset([1,2,3,4,5]):
    for E2 in powerset([1,2,3,4,5]):
        if (1 in E1) & (1 in E2): 
            B1 = -xbsb
...
for x in X:
    if  ((x[1][4] == Da) | (x[1][4] == Db)):
        b = 1
    elif ((x[1][3] == Da) | (x[1][3] == Db)) & (-x[1][4] not in sab):
        b = 1
    elif ((x[1][2] == Da) | (x[1][2] == Db)) & ((-x[1][3] not in sab) & (-x[1][4] not in sab)):
        b = 1
    elif ((x[1][1] == Da) | (x[1][1] == Db)) & ((-x[1][2] not in sab) & (-x[1][3] not in sab) & (-x[1][4] not in sab)):
        b = 1
    elif ((x[1][0] == Da) | (x[1][0] == Db)) & ((-x[1][1] not in sab) & (-x[1][2] not in sab) & (-x[1][3] not in sab) & (-x[1][4] not in sab)):
        b = 1
    elif (-x[1][0] in sab):
        b = 1     
    elif ((x[1][0] not in Dab) & (x[1][1] not in Dab) & (x[1][2] not in Dab) & (x[1][3] not in Dab) & (x[1][4] not in Dab)) & ((-x[1][0] in sab) | (-x[1][1] in sab) | (-x[1][2] in sab) | (-x[1][3] in sab) | (-x[1][4] in sab)):
        b = 1
    if b == 0:
        X0.append(x)
    b = 0             
...
for E1 in powerset([Bb,Aa,Bb,Aa,Bb]):
    Y.append(E1)
